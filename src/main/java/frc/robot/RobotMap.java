...
public class RobotMap {
    ...
    public static final int INTAKE_LEFT_FORWARD_SOLENOID = 2;// FAKE VALUES FOR TESTING
    public static final int INTAKE_LEFT_REVERSE_SOLENOID = 3;// FAKE VALUES FOR TESTING
    //Conveyor
    ...
    //Sensors
    public static final int DIO_SHOOTER_BEAM_BREAK = 3; //FAKE VALUES FOR TESTING
    public static final int DIO_PRE_INDEX_BEAM_BREAK = 2;// FAKE VALUES FOR TESTING
    public static final int DIO_INTAKE_BEAM_BREAK = 1;//FAKE VALUES FOR TESTING
    // Climber
    public static int CLIMBER_LEFT_MOTOR = 5;
    public static int CLIMBER_RIGHT_MOTOR = 7;
    public static int CLIMBER_RIGHT_FORWARD_SOLENOID = 4;
    public static int CLIMBER_RIGHT_REVERSE_SOLENOID = 5;
    public static int CLIMBER_LEFT_FORWARD_SOLENOID = 6;
    public static int CLIMBER_LEFT_REVERSE_SOLENOID= 7;
