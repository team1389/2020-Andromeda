...
public class RobotMap {
    ...
    public static final int INTAKE_RIGHT_FORWARD_SOLENOID = 1;// FAKE VALUES FOR TESTING
    public static final int INTAKE_RIGHT_REVERSE_SOLENOID = 2;// FAKE VALUES FOR TESTING
    public static final int INTAKE_LEFT_FORWARD_SOLENOID = 3;// FAKE VALUES FOR TESTING
    public static final int INTAKE_LEFT_REVERSE_SOLENOID = 4;// FAKE VALUES FOR TESTING
    //Conveyor
